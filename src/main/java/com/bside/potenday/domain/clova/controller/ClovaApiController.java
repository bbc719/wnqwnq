...
public class ClovaApiController {
    ...
    public WordResponse getClovaWordResponse(@PathVariable Long userId, @PathVariable Long interestId, @RequestParam String type) throws JsonProcessingException {
        return clovaApiService.getClovaWordResponse(userId, interestId, type);
    }
}
